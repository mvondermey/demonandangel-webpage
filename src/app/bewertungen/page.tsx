...
export default function BewertungenPage() {
  return (
    <>
      ...
      />
      <MarketingHero
        eyebrow="Vertrauen durch echte Stimmen"
        title="Kundenbewertungen aus Frankfurt"
        description="Lesen Sie, wie Kundinnen und Kunden unsere Beratung, Diskretion, Ergebnisse und Studioatmosphaere erlebt haben."
        highlights={['5.0 Sterne', `${totalReviews} Google Bewertungen`, 'Echte Erfahrungsberichte']}
      ...
      <section className="pb-4">
        <div className="mx-auto max-w-4xl px-6 text-center">
          <a
            ...
            className="inline-flex items-center gap-2 text-purple-500 hover:text-purple-600 transition-colors text-lg"
          >
      ...
      <PageCTA
        title="Werden Sie unser naechster zufriedener Kunde"
        description="Vereinbaren Sie jetzt Ihre kostenlose Erstberatung und pruefen Sie in Ruhe, welche Behandlung fuer Sie sinnvoll ist."
